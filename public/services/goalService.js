...
angular.module("myApp").service("goalService", function($http) {
  this.getRegisterData = function() {
      return $http({
          method: "GET",
          url: 'https://vintruv-fitness.herokuapp.com/api/user'
    ...
    this.getGoalData = function() {
        return $http({
            method: "GET",
            url: 'https://vintruv-fitness.herokuapp.com/api/goals'
        }).then(function(response) {
            return response.data;
        })
    }
    this.updateData = function(id,desc) {
        return $http({
            method: "PUT",
            url: 'https://vintruv-fitness.herokuapp.com/api/goal/' + id + "?desc=" + desc
        })
    }
    this.deleteData = function(id) {
        return $http({
            method: "DELETE",
            url: 'https://vintruv-fitness.herokuapp.com/api/goal/' + id
        })
    }
    this.addData = function(name,desc,price,img) {
        return $http({
            method: "POST",
            url: 'https://vintruv-fitness.herokuapp.com/api/goal/',
